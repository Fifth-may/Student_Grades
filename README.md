My code consists of four main block and 9 controls avaliable(at the moment)
Instead of just only being able to find items in a fixed database, I wanted to challenge myself to be able to :

Create a table,

Insert values into these table 
...
This is also the reason why the code was done all at once.
